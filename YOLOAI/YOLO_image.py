...
def YOLO(image):
    ...
    net = Detector(bytes(os.path.join("/home/ubuntu/ai/YOLOAI/cfg/yolov3_sub3"), encoding="utf-8"), bytes(os.path.join("weights/yolov3_sub3.weights"), encoding="utf-8"), 0, bytes(os.path.join("cfg/obj.data"),encoding="utf-8"))
